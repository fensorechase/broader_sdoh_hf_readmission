...
def main():
    ...
    # raw_mcol = mdb["smote_CHIL_1_20_raw_preds"] # If you would like to store the raw binary model predictions for each patient (0/1).
    ...
    # logCI_mcol = mdb["9_10_MLH_log_CI"] # If you would like to store 95% CI of logistic regression coefficients.
